...
public class EndlessTerrain : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        chunkSize = LevelGen.mapChunkSize - 1;
    ...
    public class TerrainChunk
    {
        ...
        public TerrainChunk(Vector2 coord, int size, LODInfo[] detailLevels, Transform parent, Material material)
        {
            ...
            levelGen.RequestMapData(position, OnMapDataReceived);
        }
        ...
        void OnMapDataReceived(MapData mapData)
        {
            ...
            Texture2D texture = TextureGenerator.TextureFromColourMap(mapData.colourMap, LevelGen.mapChunkSize, LevelGen.mapChunkSize);
    ...
    class LODMesh
    {
        ...
        public void RequestMesh(MapData mapData)
        {
            ...
            levelGen.RequestMeshData(mapData, lod, OnMeshDataReceived);
        }
    }
